from attributes.attrib_github_releases import (run, score, WEIGHT,
                                               ATTRIBUTE_SLUG)
from mock import Mock, patch

class TestAttribGitHubReleasesRun(object):
    ...
    def test_bad_response(self):
        ...
        with patch("attributes.attrib_github_releases.requests",
                   mock_request):
...
class TestAttribGitHubReleasesScore():
