from attributes.attrib_github_committers import (run, score, WEIGHT,
                                                 ATTRIBUTE_SLUG)
from mock import Mock, patch


class TestAttribGitHubCommittersRun(object):
    ...
    def test_bad_response(self):
        ...
        with patch("attributes.attrib_github_committers.requests",
                   mock_request):
...
class TestAttribGitHubCommittersScore():
