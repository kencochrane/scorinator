...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'score_projectscoreattribute', 'score_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectScoreAttribute.score_value'
        raise RuntimeError("Cannot reverse this migration. 'ProjectScoreAttribute.score_value' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ProjectScoreAttribute.score_value'
        db.alter_column(u'score_projectscoreattribute', 'score_value', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
