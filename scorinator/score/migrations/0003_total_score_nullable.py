...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'score_projectscore', 'total_score',
    ...
    def backwards(self, orm):
        ...
        # 'ProjectScore.total_score'
        raise RuntimeError("Cannot reverse this migration. "
                           "'ProjectScore.total_score' and its values "
                           "cannot be restored.")
    ...
    models = {
        ...
        u'score.projectscore': {
            'Meta': {
                'ordering': "('total_score',)", 'object_name': 'ProjectScore'},
            'date_added': ('django.db.models.fields.DateTimeField', [],
                           {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [],
                    {'primary_key': 'True'}),
