...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectScore.total_score'
        db.alter_column(u'score_projectscore', 'total_score', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectScore.total_score'
        raise RuntimeError("Cannot reverse this migration. 'ProjectScore.total_score' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ProjectScore.total_score'
        db.alter_column(u'score_projectscore', 'total_score', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
